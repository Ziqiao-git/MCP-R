...
class TestBenchmarkRunner(unittest.IsolatedAsyncioTestCase):
    ...
    @pytest.mark.skip
    async def test(self):
        trace_collector = FileCollector(log_file="log/Qwen/qwen3-30b-a3b-instruct-2507/financial_analysis_Qwen2.5_coder_32b_instruct.log")
        benchmark = BenchmarkRunner("test/financial_analysis2.yaml")
